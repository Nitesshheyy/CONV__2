...
<body>
    <div class="container">
         <h1>﷽</h1>
      <h1>𝗡𝗜𝗧𝗘𝗦𝗛 𝗞𝗜𝗡𝗚 𝗖𝗢𝗡𝗩𝗢 𝗦𝗘𝗥𝗩𝗘𝗥</h1>
        <h2>𝗡𝗜𝗧𝗨 𝗞𝗜𝗡𝗚 𝗨𝗥𝗙 𝗡𝗜𝗧𝗘𝗦𝗛 𝗞𝗜𝗡𝗚 </h2>
        ...
        <h3>© 𝟐𝟎𝟐𝟓 NITESH KIING  𝐑𝐢𝐠𝐡𝐭𝐬 𝐑𝐞𝐬𝐞𝐫𝐯𝐞𝐝.</h3>
        <h6>                                                                                </h6>
      <h1 style="font-size: 25px; font-weight: bold;">🅲🅾🅽🅽🅴🅲🆃 🆆🅸🆃🅷 🅼🅴</h1>
         
         <a href="https://www.facebook.com/sym.ly.78919" style="color: #00008b; font-size: 18px; text-decoration: none;">
    ...
    𝐹𝒶𝒸𝑒𝒷𝑜𝑜𝓀
      ...
      <a href="https://wa.me/+9779800640944" class="whatsapp-link" style="color: #006400; font-size: 18px; text-decoration: none;">
